...
class FirebaseUIManager {
     ...
     */
    createLoginUI() {
        // Chercher le placeholder dédié ou le hub-header
        ...
        if (!placeholder && !hubHeader) {
            // Créer un bouton flottant si pas de header
            this.createFloatingLoginButton();
            return;
        }

        // Créer le container de connexion
        const loginContainer = document.createElement('div');
        loginContainer.id = 'firebase-login-container';
        loginContainer.className = 'firebase-login-container';
        loginContainer.innerHTML = `
            <button id="firebase-login-btn" class="firebase-login-btn">
            ...
            <div id="firebase-user-info" class="firebase-user-info hidden">
                ...
                <span id="firebase-user-name" class="firebase-user-name"></span>
                <button id="firebase-logout-btn" class="firebase-logout-btn" title="Déconnexion">✕</button>
            </div>
        `;

        // Utiliser le placeholder si disponible, sinon append au header
        if (placeholder) {
            placeholder.appendChild(loginContainer);
        } else {
            hubHeader.appendChild(loginContainer);
        }
